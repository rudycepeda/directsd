<html><head><title>%%name%% %%secname%% (DirectSD Toolbox)</title>
...
<a href="%%next%%"><img src="../images/b_next.gif" alt="Next Page" border=0></a></td>
</tr>
</table>
...
<td align=right>%%nextname%%&nbsp;</td>
<td align=right width=20><a href="%%next%%"><img src="../images/b_next.gif" alt="Next page" border=0 align=bottom></a></td>
</tr></table>
